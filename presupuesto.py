...
por_cobranza_2023 = total_ventas_año * 0.80
...
inventario_final_deseado_2dop2dosem = int(input("Ingrese el inventario final deseado del 2do producto en el segundo semestre : "))
...
inventario_final_deseado_3erp2dosem = int(input("Ingrese el inventario final deseado del 3er producto en el segundo semestre : "))
...
datos_presupuesto_requerimiento_de_materiales= [
    ...
    ["Total de Material A requerido", total_a_1_1, total_a_1_2, total_a_1_3],
    ["Material B", "", "", ""],
    ["Requerimiento de material", req_b_1_1, req_b_1_2, req_b_1_3],
    ["Total de Material B requerido", total_b_1_1, total_b_1_2, total_b_1_3],
    ["Material C", "", "", ""],
    ["Requerimiento de material", req_c_1_1, req_c_1_2, req_c_1_3],
    ["Total de Material C requerido", total_c_1_1, total_c_1_2, total_c_1_3],
    ["PRODUCTO 2", "", "", ""],
...
print("\nAÑO")
depreciacion3 = float(input('Ingrese monto de depreciacion del año: '))
sueldos_y_salarios3 = float(input('Ingrese monto de sueldos y salarios del año: '))
varios3O = float(input('Ingrese monto de varios del año: '))
intereses_prestamo3 = float(input('Ingrese monto de intereses del prestamo del año: '))

# Calcular los valores para el presupuesto de gastos de operaciom
total_comisiones1 = total_ventas_1sem * 0.01
total_comisiones2 = total_ventas_2sem * 0.01
total_comisiones3 = total_ventas_año * 0.01
...
total_ventas_año = total_ventas_1sem + total_ventas_2sem 
costo_ventas= total_produccion - total_de_costos
utilidad_bruta=float(input("Ingrese la utilidad bruta: "))
gastos_operacion= total_gastos_operacion1 + total_gastos_operacion2 
utilidad_operacion= utilidad_bruta - gastos_operacion
isr=float(input("Ingresa el ISR: "))
ptu=float(input("Ingresa el PTU: "))
...
print(tabulate(estado_de_resultados, headers=["Presupuesto del X al X de 20XX",""], tablefmt="fancy_grid"))
...
activo_fijo=float(input("Ingresa el activo fijo: "))
isr2=float(input("Ingresa el ISR de la redaccion: "))
isr
...
estado_de_flujo_efectivo=[
    ...
    ["Flujo de efectivo actual", flujo_efectivo ],  
]

print(tabulate(estado_de_flujo_efectivo, headers=["Presupuesto del X al X de 20XX",""], tablefmt="fancy_grid"))
...
terreno=float(input("Ingresa la cantidad de terreno: "))
planta_equipo=float(input("Ingrese la cantidad de planta y equipo: "))
documentos_por_pagar= float(input("Ingrese la cantidad de documentos por pagar: "))
total_pasivo_corto_plazo= saldo_proveedores_año + documentos_por_pagar + ptu
obligaciones_por_pagar=float(input("Ingrese la cantidad de obligaciones por pagar: "))
pasivo_total= obligaciones_por_pagar + total_pasivo_corto_plazo
capital_aportado=float(input("Ingrese la cantidad de capital aportado: "))
capital_ganado=float(input("Ingrese la cantidad de capital ganado: "))
...
print(tabulate(balance_general1, headers=["Balange General",""], tablefmt="fancy_grid"))
